...
fence-create link-bucket-to-project --bucket_id phs000920.c1 --bucket_provider google --project_auth_id topmed
fence-create link-bucket-to-project --bucket_id phs000921.c2 --bucket_provider google --project_auth_id topmed
